  ...
  integrations: [
    ...
    expressiveCode({
      ...
      styleOverrides: {
        ...
        frames: {
          frameBoxShadowCssValue: '0 4px 12px -2px rgb(0 0 0 / 0.08), 0 2px 6px -1px rgb(0 0 0 / 0.04)',
          editorActiveTabIndicatorBottomColor: 'var(--primary)',
          editorActiveTabIndicatorTopColor: 'transparent',
          editorActiveTabForeground: 'var(--foreground)',
          editorActiveTabBackground: 'var(--background)',
          editorTabBarBackground: 'color-mix(in oklab, var(--secondary) 40%, transparent)',
