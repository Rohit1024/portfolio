...
description: >-
  Set up a private GKE cluster accessible to internal CI/CD pipelines using
  Cloud Build DNS endpoints.
date: 2026-05-25
draft: false
tags:
  - gcp
...
<Callout variant="note" title="Private worker pool required" defaultOpen>
...
<Callout variant="important" title="Prerequisites" defaultOpen>
