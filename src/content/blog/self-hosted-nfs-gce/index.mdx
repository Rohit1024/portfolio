...
description: >-
  Set up a self-hosted NFS server on Google Compute Engine and mount it to Cloud
  Run using Direct VPC egress.
date: 2026-05-30
draft: false
tags:
  - gcp
...
<Callout variant="warning" title="Data loss warning" defaultOpen>
...
<Callout variant="note" title="Google documentation" defaultOpen>
